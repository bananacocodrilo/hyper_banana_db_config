 ...
 */
 $wpdb->add_database(array(
 	'host'     => $_ENV["MARIADB_HOST"]:$_ENV["MARIADB_PORT_NUMBER"],     // If port is other than 3306, use host:port.
 	'user'     => $_ENV["WORDPRESS_DATABASE_USER"],
 	'password' => $_ENV["WORDPRESS_DATABASE_PASSWORD"],
 	'name'     => $_ENV["WORDPRESS_DATABASE_NAME"],
 ));
 ...
 */
$wpdb->add_database(array(
	'host'     => $_ENV["MARIA_SLAVE_HOST"]:$_ENV["MARIADB_PORT_NUMBER"],     // If port is other than 3306, use host:port.
	'user'     => $_ENV["MARIADB_REPLICATION_USER"],
	'password' => $_ENV["MARIADB_REPLICATION_PASSWORD"],
	'name'     => $_ENV["WORDPRESS_DATABASE_NAME"],
	'write'    => 0,
	'read'     => 1,
	'dataset'  => 'global',
